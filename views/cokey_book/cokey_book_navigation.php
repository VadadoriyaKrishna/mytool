            ...
            <div class="rec-panel card-tab-right d-flex flex-column"> 
                <div class="header-tab-option">  <!--header-tab-option-->
                    <ul class="nav nav-tabs header-tab-menu">
                        <li>
                            <a href="javascript:void(0);" data-add_btn_text="Add CokeyBook" class="add_btn_li <?php echo ($subTab == 0 || $subTab == "20.26.1") ? 'active' : ''; ?>" onclick="loadData('<?php echo $routeFilePath; ?>?currentPage=20.26.1', 'ajax-cokey-tab', 0);">

                                <i class="fas fa-list"></i>CokeyBook List
                            </a>
                        </li>
                    </ul>
                    <span class="tab-text-small rx-rigth-btn "> 
                        <a href="javascript:void(0);" class="add_new_data">Add CokeyBook</a> 
                    </span>
