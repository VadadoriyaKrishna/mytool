...
<div class="container">
    ...
    <div class="form-inner pt-4" id="Camera_form_div" style="display: none;">
        <form method="post" action="" id="Camera_form" enctype="multipart/form-data">
            <input type="hidden" id="Camera_id" name="Camera_id" value='["id","nvr_id","channel_id","name","status","created_by","created_on","updated_by","updated_on","deleted_by","deleted_on","is_deleted"]' />
